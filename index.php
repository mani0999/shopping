...
<html lang="en">
	<head>
	    ...
	    <title>Dublin Online Shopping Home Page</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over EUROS. 600.00</h6>	
				</div>
			</div><!-- .col -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					EUROS.<?php echo htmlentities($row['productPrice']);?>			</span>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
												EUROS. <?php echo htmlentities($row['productPrice']);?>
												</span>
